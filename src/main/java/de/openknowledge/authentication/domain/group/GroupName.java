...
public class GroupName extends AbstractStringValueObject {
  ...
  public static GroupName fromValue(String groupName) {
    notBlank(groupName, "groupName may not be blank");
